...
* `0`: `"Постинг запрещён. Бан: 908831. Причина: [W] United States (AMAZON-2011L)."`. См. код ошибки `-6`.
...
```js
{
  ...
  // * "russian" — Что-то на русском (при этом на дату 22.10.2023, там стоит "russian" даже если капча — это уравнение).
  input: "russian",
  ...
  challenge: "2fba39397f4c708c01710ffa1b071f2436539538bae07a76254eef08ce11be0e7482619256be1fa676896de9c80e2c13787ffb2f0c494cd9de0056a8dda577a8"
}
```
