...
export default class Engine {
	...
	voteForComment(params) {
		if (!this.parseVoteForCommentResponse) {
			throw new Error('`.voteForComment()` is not implemented for this engine')
		}
	...
	solveCaptcha(params) {
		if (!this.parseSolveCaptchaResponse) {
			throw new Error('`.solveCaptcha()` is not implemented for this engine')
		}
	...
	reportComment(params) {
		if (!this.parseReportCommentResponse) {
			throw new Error('`.reportComment()` is not implemented for this engine')
		}
