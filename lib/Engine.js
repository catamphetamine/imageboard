...
export default class Engine {
	...
	getBoards(parameters) {
		return getBoards({
			...
			explicitContentBoards: this.options.explicitContentBoards,
			explicitContentBoardCategories: this.options.explicitContentBoardCategories,
	...
	/**
	 * Performs a "rate" API request and parses the response.
	 ...
	 */
	rateComment(params) {
		return this.callApiEndpoint(this.options.api.rate, params, {
			parseResponse: this.parseRateCommentResponse
		})
	}
