...
import TahtaChConfig from '../../chans/tahtach/index.json.js'
import DioChanConfig from '../../chans/diochan/index.json.js'
import VecchioChanConfig from '../../chans/vecchiochan/index.json.js'
import NiuChanConfig from '../../chans/niuchan/index.json.js'
import TwentySevenChanConfig from '../../chans/27chan/index.json.js'
import HeolCafeConfig from '../../chans/heolcafe/index.json.js'
...
const IMAGEBOARDS = [
	...
	{ id: TahtaChConfig.id, imageboard: TahtaCh },
	{ id: DioChanConfig.id, imageboard: DioChan },
	{ id: VecchioChanConfig.id, imageboard: VecchioChan },
	{ id: NiuChanConfig.id, imageboard: NiuChan },
	{ id: TwentySevenChanConfig.id, imageboard: TwentySevenChan },
	{ id: HeolCafeConfig.id, imageboard: HeolCafe }
]
