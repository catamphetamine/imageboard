...
import parseRenewBlockBypassResponse from './blockBypass/parseRenewBlockBypassResponse.js'
...
export default class LynxChan extends Engine {
	...
	/**
	 * Parses "renew block bypass" API response.
	 * @param  {object} response
	 */
	parseRenewBlockBypassResponse(response) {
		return parseRenewBlockBypassResponse(response)
	}
