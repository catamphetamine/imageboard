...
export const link = {
	...
	createElement(content, { getAttribute }, { commentUrlParser }) {
		...
		if (postLink) {
			return {
				type: 'post-link',
				boardId: postLink.boardId || null, // Will be overwritten anyway later in comment post-processing.
				threadId: postLink.threadId || null, // Will be overwritten anyway later in comment post-processing.
