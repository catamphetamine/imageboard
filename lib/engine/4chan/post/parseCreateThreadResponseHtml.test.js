import parseCreateThreadResponse from './parseCreateThreadResponseHtml.js'

describe('parseCreateThreadResponse (HTML)', () => {
	...
	it('should parse create thread response (error: spam)', () => {
		expect(() => {
			parseCreateThreadResponse('<html><body><div id="errmsg">Error: Our system thinks your post is spam. Please reformat and try again.</div></body></html>')
