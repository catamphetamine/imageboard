...
import LainChan from '../../../chans/lainchan/index.js'
...
describe('lainchan.org', () => {
  it('should parse thread', () => {
    expectToEqual(
      ...
      }).parseThread(API_RESPONSE, { boardId: 'λ', threadId: 14298 }).thread,
      RESULT
    )
  })
})
      ...
      "attachments": [
        {
          ...
          "file": {
            ...
            "width": 200,
            "height": 200,
            "url": "/λ/src/1563642402862-0.pdf",
            "picture": {
              "width": 200,
              "height": 200,
              "type": "image/png",
              "url": "/λ/thumb/1563642402862-0.png"
            }
          }
        },
        {
          ...
          "picture": {
            ...
            "height": 499,
            "size": 26130,
            "url": "/λ/src/1563642402862-1.jpg",
            "sizes": [ {
              "type": "image/png",
              "width": 227,
              "height": 300,
              "url": "/λ/thumb/1563642402862-1.png"
            }]
          }
        }
      ]
