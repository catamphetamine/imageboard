import { canGeneratePostQuoteIgnoringNestedPostQuotes } from 'social-components/post'

import createContentPreview from './createContentPreview.js'
 ...
 * @param {function} [options.generatedQuoteGetCharactersCountPenaltyForLineBreak]
...
export function generatePostLinksAndUpdatePreview(comment, {
	...
	if (!hasBeenCalledBefore) {
		...
		// because it sets `isDeleted: true` flags for deleted comments.
